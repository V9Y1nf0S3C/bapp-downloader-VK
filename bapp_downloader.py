...
BAPP_IDS = [
    ...
    ('Additional Scanner Checks','Additional_Scanner_Checks.bapp','a158fd3fc9394253be3aa0bc4c181d1f'),
    ...
    ('Backslash Powered Scanner','Backslash_Powered_Scanner.bapp','9cff8c55432a45808432e26dbb2b41d8'),
    ...
    ('SAMLReQuest','SAMLReQuest.bapp','ec94f32a5b1f467bbb1459398818156f'),
